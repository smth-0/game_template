...
export class World {
            ...
            if (keys[key]) {
                ...
                switch (key) {
                    ...
                    case "a":
                        ...
                        break;
                    case "d":
                        this.player.x > (window.innerWidth-this.player.r-this.multyplier-1) ? this.player.set_cords((window.innerWidth-this.player.r-this.multyplier-1), this.player.y) : this.player.go_right();
                        break;
                    case "s":
    ...
    get_items() {
        return [this.player, new Info(this.player.x, this.player.y, this.mouseX, this.mouseY, this.laser.length), ...this.laser]
    }
}
